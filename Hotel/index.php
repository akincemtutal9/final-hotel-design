...
<html lang="en">
<head>
<title>AKIN CEM HOTEL</title>
<!-- for-mobile-apps -->
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords" content="5-star , book, room, rooms, hotel" />
...
<div class="banner-top">
    ...
    <?php endif ?>
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:info@example.com">Hotel@Gmail.COM</a></li>
		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">AKIN CEM HOTEL</span><p class="logo_w3l_agile_caption">Cool Hotel</p></a></h1>
				</div>
				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<nav class="menu menu--iris">
						<ul class="nav navbar-nav menu__list">
							...
							<li class="menu__item"><a href="login.php" class="menu__link scroll">Log Out</a></li>
					</nav>
				</div>
			</nav>
				...
				<ul class="cbp-ig-grid">
					<li>
						<div class="w3_grid_effect">
							...
							<span class="cbp-ig-category">AKIN CEM HOTEL</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
						   ...
						   <p class="about-para-w3ls">Cool Hotel</p>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>NUMBER</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">Hotel@Gmail.com</a></p>
			<p class="contact-agile1"><strong>Address :</strong>Antalya Akdeniz UNİ</p>
			...
			<iframe src="https://www.google.com/maps/place/Akdeniz+Üniversitesi/@36.8945335,30.655353,15z/data=!4m5!3m4!1s0x0:0xfbd4e14587332eeb!8m2!3d36.8945335!4d30.655353" ></iframe>
		</div>
		<div class="clearfix"></div>
	</div>
</section>
